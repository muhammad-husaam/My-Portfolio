...
Hands-on IT projects demonstrating practical skills in **PowerShell automation**, **Windows Server administration**, **Active Directory**, and **network troubleshooting**. Focused on solving real-world IT challenges and improving efficiency with measurable impact.

---

## 🔧 PowerShell Automation
Automated repetitive IT tasks to save time, reduce errors, and improve system reliability:

- 🖥️ **System Health Check** – Monitors CPU, RAM, and disk usage.  
  ![⚡ Impact](https://img.shields.io/badge/Impact-80%25-brightgreen)  
  `healthcheck.ps1`
  
- 🧹 **Temp File Cleanup** – Frees system space automatically.  
  ![💾 Saved Space](https://img.shields.io/badge/Saved-2GB%2Fweek-blue)  
  `cleanup.ps1`

- ⚠️ **Disk Usage Alert** – Alerts when disk space is below 20GB.  
  ![✅ Downtime Prevented](https://img.shields.io/badge/Downtime-Prevented-success)  
  `diskalert.ps1`
...
- 🌐 **Network Troubleshooting Runbook** – Structured guide to resolve common network issues.  
  ![⏱️ Efficiency](https://img.shields.io/badge/Time-Saved_50%25-orange)  
  `network-runbook.md`

- 🏠 **Windows Server 2022 Lab** – Configured AD DS, DNS, domain (`lab.local`).  
  ![👥 Users Supported](https://img.shields.io/badge/Users-50%2B-lightgrey)  
  `homelab.md`

- 🌐 **DHCP Server Setup** – Automated IP assignment.  
  ![⚡ Error-Free](https://img.shields.io/badge/Manual_Errors-0-success)  
  `dhcp-setup.md`
...
- 🔒 **Security Scan Report** – Nmap scan of AD Domain Controller, identifying 9 open ports and security gaps.  
  ![🛡️ Secured](https://img.shields.io/badge/Security-Improved-brightgreen)  
  `security-scan-report.md`

- 👥 **Bulk User Creation** – Automated AD user provisioning from CSV.  
  ![⏱️ Users Created](https://img.shields.io/badge/Users-100%2B-in_2min-blue)  
  `bulkusers.ps1`
...
![Active Directory](https://img.shields.io/badge/AD-005A9E?logo=microsoftazure&logoColor=white)  
...
- **Automated VLAN Configuration Script** (`vlan-config.ps1`) – Deploy VLANs on multiple switches. **Manual errors eliminated**  
...
- **AD Health Check Script** (`ad-healthcheck.ps1`) – Replication, DNS, DC status. **Manual checks reduced from hours to minutes**  
- **Automated Password Reset & Notification** (`password-reset.ps1`) – Detect expired passwords. **Reduced account lockouts/helpdesk tickets**  
- **AD Security Audit Automation** (`ad-security-audit.ps1`) – Identify inactive accounts/admin privileges. **Audit time reduced drastically**  
- **Automated AD Backup & Restore** (`ad-backup.ps1`) – Schedule backups and restore AD. **Zero downtime in recovery scenarios**
